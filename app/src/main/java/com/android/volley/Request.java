...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    public boolean isForceRequest() {
        return mForceRequest;
    }

    public void setForceRequest(boolean mForceRequest) {
        this.mForceRequest = mForceRequest;
    }
    ...
    public String getCacheKey() {
        try {
            if (mMethod == Method.POST && (getParams() != null && getParams().size() != 0)) {
