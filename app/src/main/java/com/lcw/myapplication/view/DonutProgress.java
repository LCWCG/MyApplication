...
//        canvas.drawCircle(getWidth() / 2.0f, getHeight() / 2.0f, innerCircleRadius, innerCirclePaint);
        canvas.drawCircle(getWidth() / 2.0f, getHeight() / 2.0f, innerCircleRadius - finishedStrokeWidth, innerCirclePaint);
        canvas.drawArc(finishedOuterRect, getStartingDegree() - 90, getProgressAngle(), false, finishedPaint);
        canvas.drawArc(unfinishedOuterRect, getStartingDegree() + getProgressAngle() - 90, 360 - getProgressAngle(), false, unfinishedPaint);
