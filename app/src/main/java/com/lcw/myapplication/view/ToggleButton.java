...
public class ToggleButton extends View {
     ...
     * 开启颜色
     */
    private int onColor = Color.parseColor("#45D190");
    /**
     * 关闭颜色
     */
    ...
    public void setToggle(boolean value, boolean animate) {
        if (value) {
            setToggleOn(animate);
        } else {
    ...
    protected void onLayout(boolean changed, int left, int top, int right,
        ...
        startX = radius + getPaddingLeft();
        endX = width - radius + getPaddingLeft();
